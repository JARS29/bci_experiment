...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'C:\\Users\\JARS\\BCI\\untitled.psyexp',
...
sound_1 = sound.Sound(u'440', secs=1.0)
sound_1.setVolume(1)
...
for thisTrial in trials:
    ...
    sound_1.setSound(u'440', secs=1.0)
    image.setOri(ori)
    image.setImage(img)
    # keep track of which components have finished
    trialComponents = [sound_1, polygon, image]
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        # *image* updates
        if t >= 3.0 and image.status == NOT_STARTED:
            # keep track of start time/frame for later
            image.tStart = t
